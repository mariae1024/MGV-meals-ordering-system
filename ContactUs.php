...
<div class="collapse" id="navbarToggleExternalContent">
  ...
  <nav class="navbar fixed-top navbar-dark bg-dark nav-pills"><!-- hovering with jquery not working-->
...
<div class="container" style="margin-left:80px;margin-right:80px;">
          <div class="row mt-5 mb-5">
              <div class="col-md-6 mt-3">
                  <h3>Contact Us</h3>
                <form class="form-signin" action="senddatafeedback.php" method="POST">
                
                    
                    <div class="form-group">
                  <label for="formGroupExampleInput">First Name</label>
                  <input type="text" class="form-control"  name="fname" required="required"  pattern="[A-Za-z ]{1,15}" placeholder="Enter your first name">
                  </div>
                    
                    <div class="form-group">
                  <label for="formGroupExampleInput">Last Name</label>
                  <input type="text" class="form-control"  name="lname" required="required" pattern="[A-Za-z ]{1,15}" placeholder="Enter your last name">
                  </div>
                    
                    <div class="form-group">
                    <label for="Pnumber">Phone Number</label>
                    <input type="number" class="form-control"  name="phone" required="required" pattern="[0-9 ]{1,20}" placeholder="Phone Number">
                    </div>

                    <div class="form-group">
                        <label for="email">Email address</label>
                        <input type="email" class="form-control"  name="email" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="name@example.com">
                    </div>

                    <div class="form-group">
                      <label for="comment">Feedback:</label>
                      <textarea class="form-control" rows="5"  name="feedback" required="required"></textarea>
                    
                    </div>

                    <input type="submit"  name="feedbackpost" class="btn btn-primary btn-lg" > 
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="row text-center text-white mt-2">
                        <div class="col-md-4">
                          ...
                          <p>20 Hobson Street, Auckland 1010</p>
                          <p>New Zealand</p>
                        </div>
                        ...
                        <div class="col-md-4">
                          ...
                          <p>+ 64 223 299 794</p>
                          <p>Avaliable 24/7 through the year</p>
                        </div>
