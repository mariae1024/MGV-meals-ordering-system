...
<html>
  ...
  <nav class="navbar fixed-top navbar-dark bg-dark nav-pills"><!-- hovering with jqury not working-->
   <a class="navbar-brand nav-link active" href="index.php">MGV</a>
...
<div class="container-fluid" id="background">
          <div class="row">
              <div class="col">
                <h1>MGV</h1>
				<p id="slogan"><b>Ride with pride</b></p>
				<hr>
				<button class="btn btn-secondary btn-lg index-btn-color"><a href="Vehicles.php" style="color:white;text-decoration: none;"><i class="fa fa-road" aria-hidden="true"></i>Get Started</a></button>
              </div>
   </div>
</div>
