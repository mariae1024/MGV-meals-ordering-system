            ...
            <form class="form-signin" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputfname"><b>First Name: </b> <?php echo $r['fname']; ?></label>
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputlname"><b>Last Name: </b><?php echo $r['lname']; ?></label>
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputEmail"><b>Email: </b><?php echo $r['email']; ?></label>
                 ...
                 <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputphone"><b>Phone number: </b><?php echo $r['phone']; ?></label>
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputPassword"><b>Password: </b><?php echo $r['password']; ?></label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <a href="editprofile.php?id=<?php echo $r['id'] ?>"><button type="button" class="btn btn-primary btn-lg">Edit</button></a>
                        <a href="passchange.php?id=<?php echo $r['id'] ?>"><button type="button" class="btn btn-warning btn-lg">Change password</button></a>
