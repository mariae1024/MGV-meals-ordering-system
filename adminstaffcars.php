            ...
            <ul class="nav flex-column">
              ...
              <?php
                if(isset($_SESSION["is_auth"])) {
                  ...
                  ?>
              <li class="nav-item">
                <a class="nav-link active" href="adminstaffcars.php">
...
<table class="table table-striped table-sm">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Kilometers(Km)</th>
      <th scope="col">Engine size (cc)</th>
      <th scope="col">Fuel Type</th>
      <th scope="col">Model Details</th>
  ...
  <tbody>
           <?php 
                    ...
                    <td>
                    <a href="updatecar.php?id=<?php echo $r['id']; ?>"><button type="button" class="btn btn-primary">Edit</button></a>
                    
		            			<!--write the delete code yourself-->
                      
                      <button type="button" class="btn btn-danger trash" data-toggle="modal" data-id="<?php echo $r['id']; ?>" data-target="#deletecar" > Delete</button></td>
                        <?php endwhile; ?>
              </tbody>
               ...
               <a href="addcars.php"><button type="button" class="btn btn-success mb-5">Add Car</button></a>
