...
$ReadSql = "SELECT * FROM product_cars";
  ...
  <?php 
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-xs-6 mt-3 mb-3">
             
              <?php
               echo '<img src="data:cars/jpg;base64,'.base64_encode($r['image'] ).'" height="450" width="600" class="img-thumnail" />';
               ?> 
            </div>
            <div class="col-xs-6 offset-md-1 mt-3">
            
            <div class="col">
              <h5><b>Product: </b><?php echo $r['name']; ?></h5>
              <h5><b>Year: </b><?php echo $r['year']; ?></h5>
              <h5><b>Kilometers (km): </b><?php echo $r['kilometers']; ?></h5>
              <h5><b>Engine size (cc): </b><?php echo $r['engine']; ?></h5>
              <h5><b>Fuel type: </b><?php echo $r['fuel']; ?></h5>
              <h5><b>Model details: </b><?php echo $r['model']; ?></h5>
              <h5><b>Price: </b><?php echo $r['price']; ?></h5>
            </div>
              ...
              <?php
               if(isset($_SESSION["is_auth"])) {
                //echo '<a href="bookings.php?id=."><button type="button" class="btn btn-primary ml-5 mt-5">Book Now</button></a>';
                   ...
                   echo '<a href="bookings.php?id='.$r['id'].'"><button type="button" class="btn btn-lg btn-primary mt-5 ml-5">Book Now</button></a>';
                }
                ?>
            </div>
            </div>
